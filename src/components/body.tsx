...
function Body() {
  return (
    <div  className="bg-gray-900   flex  justify-between items-center px-10 ">
      {/* Desktp*/}
      <div className="text-left mb-[60px] hidden md:block">
      ...
      <div className="mb-[50px] hidden md:block">
      ...
      {/* moblie phone */}
      <div id="home1"className="container  bg-gray-900  mx-auto max-w-full h-full text-white p-4 md:hidden">
        <div className="mb-7 text-center md:hidden">
          ...
          <button className="bg-gray-900 text-orange-500 border-2 border-orange-500 rounded-lg font-semibold px-4 py-2 mt-5">
            <a href="https://www.facebook.com/profile.php?id=100085781894180">
              Contact me
            </a>
          </button>
        </div>
